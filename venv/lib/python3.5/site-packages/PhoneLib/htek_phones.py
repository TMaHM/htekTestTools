...
class Phone(TestUrl):
    ...
    def flexible_seating(self, aid, number, pwd, method: str):
        ...
        if r_flex_s[0] == 200:
            ...
            img_file = self.screen_shot('flx_{}'.format(method))
            if img_file.isdigit() is not True:
                img = Image.open(img_file)
                print(img.size)
                cropped = img.crop((0, 0, 128, 128))
                cropped.save('./flx_img_temp.jpg')
                img_compare('./flx_img_temp.jpg', './img/flx_img.jpg')
